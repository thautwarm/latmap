...
IGNORES = (6,)
UNIONALL_INFO = ((None, None), (6, None), (2, {'define': 4}), (5, None), (3, None))
UNIONALL_INFO_BYTES = ((None, None), (6, None), (2, {b'define': 4}), (5, None), (3, None))
numbering = {'BOF': 0, 'EOF': 1, 'identifier': 2, 'quote (': 3, 'quote define': 4, 'quote )': 5, 'space': 6}
