...
IGNORES = (6,)
UNIONALL_INFO = ((None, None), (6, None), (0, {'define': 3}), (2, None), (1, None))
UNIONALL_INFO_BYTES = ((None, None), (6, None), (0, {b'define': 3}), (2, None), (1, None))
numbering = {'identifier': 0, 'quote (': 1, 'quote )': 2, 'quote define': 3, 'BOF': 4, 'EOF': 5, 'space': 6}
